...
const initialTasks: Task[] = [
  // TODO: replace this with actual API call to fetch tasks for the active sprint of the project
  {
    ...
    description:
      "Implement user authentication using NextAuth.js with support for email/password and OAuth providers.",
    priority: "high",
    status: "done",
    assignedAgent: "Architect",
    agentNotes:
      "Recommended OAuth for faster user adoption. Email/password as fallback.",
    subTasks: [
  ...
  },
  {
    ...
    description:
      "Create the main dashboard layout with responsive sidebar navigation and header components.",
    priority: "high",
    status: "done",
  ...
  },
  {
    ...
    description:
      "Build a form to add new expenses with category selection, amount input, and date picker.",
    priority: "medium",
    status: "in-progress",
  ...
  },
  {
    ...
    description:
      "Build interactive charts to visualize spending patterns by category and time period.",
    priority: "medium",
    status: "in-progress",
    assignedAgent: "Architect",
  },
  {
    ...
    description:
      "Design and implement the PostgreSQL schema for storing user transactions and categories.",
    priority: "critical",
    status: "done",
    assignedAgent: "Architect",
    agentNotes:
      "Using Prisma ORM for type-safe database access. Schema includes soft delete for data recovery.",
  },
  {
    id: "6",
    title: "Build AI budget recommendation engine",
    description:
      "Implement the AI service that analyzes spending patterns and generates personalized budget recommendations.",
    priority: "high",
    status: "todo",
    assignedAgent: "Planner",
    agentNotes:
      "Scheduled for Sprint 3. Requires transaction history feature first.",
  },
  {
    id: "7",
    title: "Add recurring expense support",
    description:
      "Allow users to set up recurring expenses that automatically generate transactions.",
    priority: "low",
    status: "todo",
    assignedAgent: "Task Manager",
  },
  {
    ...
    description:
      "Add functionality to export transaction data to CSV format for external analysis.",
    priority: "low",
    status: "blocked",
    assignedAgent: "Debug Agent",
    agentNotes:
      "Blocked by missing data formatting library. Recommend date-fns.",
  },
];
                  ...
                  >
                    ...
                    <div className="h-2 bg-secondary rounded-full overflow-hidden">
                      <div
                        className="h-full bg-gradient-to-r from-primary to-accent rounded-full transition-all duration-500"
                        style={{
                          width: `${(sprint.completed / sprint.tasks) * 100}%`,
                        }}
                      />
                    </div>
                  </div>
