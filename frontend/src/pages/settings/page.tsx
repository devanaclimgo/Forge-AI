...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-lg border border-border bg-card p-6">
              <div className="flex items-center gap-4 mb-6">
                <div className="flex h-16 w-16 items-center justify-center rounded-full bg-background20 text-brand text-xl font-bold">
      ...
      {showDeleteModal && (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center bg-popover/80 backdrop-blur-sm animate-in fade-in duration-150"
